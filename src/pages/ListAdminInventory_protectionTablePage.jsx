    ...
    const columns = [
    {
        ...
        {
            header: 'Replacement Item Id',
            accessor: 'replacement_item_id',
            isSorted: false,
            isSortedDesc: false,
            mappingExist : false,
            mappings: {  }
    ...
    const InventoryProtectionListPage = () => {
    ...
    const onSubmit = (_data) => {
        ...
        let item_id = getNonNullValue(_data.item_id);
        let replacement_item_id = getNonNullValue(_data.replacement_item_id);
    ...
    return (
        ...
        >
            <h4 className="text-2xl font-medium">Inventory Protection Search</h4>
        ...
        <div className="overflow-x-auto  p-5 bg-white shadow rounded">
            ...
            <h4 className="text-2xl font-medium">Inventory Protection</h4>
            <div className="flex">
                <AddButton link={"/admin/add-inventory_protection"} />
                    ...
                    <tr key={i}>
                        ...
                        if (cell.accessor == "") {
                            ...
                            >
                                ...
                                className="text-xs"
                                onClick={() => {
                                    navigate("/admin/edit-inventory_protection/" + row.id, {
                                    state: row,
                                    });
                                }}
                                >
                                ...
                                onClick={() => {
                                    navigate("/admin/view-inventory_protection/" + row.id, {
                                    state: row,
                                    });
                                }}
                                >
    ...
    export default InventoryProtectionListPage;
