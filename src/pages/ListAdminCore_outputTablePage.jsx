    ...
    const onSubmit = (_data) => {
        ...
        let core_id = getNonNullValue(_data.core_id);
        let filter = {
        id,
    ...
    return (
        ...
        >
            <h4 className="text-2xl font-medium">Core Output Search</h4>
            ...
            <input
              ...
              {...register("core_id")}
              className={`shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline ${
                errors.core_id?.message ? "border-red-500" : ""
              }`}
            />
            <p className="text-red-500 text-xs italic">
              {errors.core_id?.message}
            </p>
          </div>
        ...
        <div className="overflow-x-auto  p-5 bg-white shadow rounded">
            ...
            <h4 className="text-2xl font-medium">Core Output</h4>
            <div className="flex">
                <AddButton link={"/admin/add-core_output"} />
                    ...
                    <tr key={i}>
                        ...
                        if (cell.accessor == "") {
                            ...
                            >
                                ...
                                className="text-xs"
                                onClick={() => {
                                    navigate("/admin/edit-core_output/" + row.id, {
                                    state: row,
                                    });
                                }}
                                >
                                ...
                                onClick={() => {
                                    navigate("/admin/view-core_output/" + row.id, {
                                    state: row,
                                    });
                                }}
                                >
    ...
    export default CoreOutputListPage;
