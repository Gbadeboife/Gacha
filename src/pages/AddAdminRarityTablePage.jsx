...
const AddRarityPage = () => {
  ...
  return (
    <div className=" shadow-md rounded  mx-auto py-5 px-10">
      <h4 className="text-2xl font-medium mb-10">Add Rarity</h4>
      <form className=" w-full max-w-lg" onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="mb-4  ">
          ...
          <input
            type="color"
            {...register("color")}
            className={`shadow appearance-none border rounded w-[30px] h-[30px] text-gray-700 leading-tight focus:outline-none focus:shadow-outline ${
              errors.color?.message ? "border-red-500" : ""
            }`}
          />
          <p className="text-red-500 text-xs italic">{errors.color?.message}</p>
        </div>
