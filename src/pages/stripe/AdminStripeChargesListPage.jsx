...
const AdminStripechargesListPage = () => {
  ...
  async function getData(paginationParams) {
    try {
      const { list: charges, limit, error, message } = await sdk.getStripeCharges(paginationParams);
      console.log(charges);
      if (error) {
...
export default AdminStripechargesListPage;
