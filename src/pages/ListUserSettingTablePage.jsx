    ...
    const onSubmit = (_data) => {
        ...
        let setting_key = getNonNullValue(_data.setting_key);
        let setting_value = getNonNullValue(_data.setting_value);
    ...
    return (
        ...
        >
            <h4 className="text-2xl font-medium">Setting Search</h4>
        ...
        <div className="overflow-x-auto  p-5 bg-white shadow rounded">
            ...
            <div className="flex">
                <AddButton link={"/user/add-setting"} />
                    ...
                    <tr key={i}>
                        ...
                        if (cell.accessor == "") {
                            ...
                            >
                                ...
                                className="text-xs"
                                onClick={() => {
                                    navigate("/user/edit-setting/" + row.id, {
                                    state: row,
                                    });
                                }}
                                >
                                ...
                                onClick={() => {
                                    navigate("/user/view-setting/" + row.id, {
                                    state: row,
                                    });
                                }}
                                >
