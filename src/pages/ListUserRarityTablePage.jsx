    ...
    return (
        ...
        >
            <h4 className="text-2xl font-medium">Rarity Search</h4>
        ...
        <div className="overflow-x-auto  p-5 bg-white shadow rounded">
            ...
            <h4 className="text-2xl font-medium">Rarity</h4>
            <div className="flex">
                <AddButton link={"/user/add-rarity"} />
                    ...
                    <tr key={i}>
                        ...
                        if (cell.accessor == "") {
                            ...
                            >
                                ...
                                className="text-xs"
                                onClick={() => {
                                    navigate("/user/edit-rarity/" + row.id, {
                                    state: row,
                                    });
                                }}
                                >
                                ...
                                onClick={() => {
                                    navigate("/user/view-rarity/" + row.id, {
                                    state: row,
                                    });
                                }}
                                >
