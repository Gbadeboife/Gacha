    ...
    return (
        ...
        <h4 className="text-2xl font-medium">View Project Items</h4>
            ...
            <div className="mb-4 mt-4">
                <div className="flex mb-4">
                    ...
                    <div className="flex-1">{viewModel?.rarity}</div>
                </div>
            </div>
            ...
            <div className="mb-4 mt-4">
                <div className="flex mb-4">
                    <div className="flex-1">Rarity Color</div>
                    <div className="flex-1">{viewModel?.rarity_color}</div>
                </div>
            </div>
            ...
            <div className="mb-4 mt-4">
                <div className="flex mb-4">
                    ...
                    <div className="flex-1">{viewModel?.unit}</div>
                </div>
            </div>
    ...
    export default ViewProjectItemsPage;
