    ...
    return (
        ...
        >
            <h4 className="text-2xl font-medium">Core Search</h4>
        ...
        <div className="overflow-x-auto  p-5 bg-white shadow rounded">
            ...
            <h4 className="text-2xl font-medium">Core</h4>
            <div className="flex">
                <AddButton link={"/admin/add-core"} />
                    ...
                    <tr key={i}>
                        ...
                        if (cell.accessor == "") {
                            ...
                            >
                                ...
                                className="text-xs"
                                onClick={() => {
                                    navigate("/admin/edit-core/" + row.id, {
                                    state: row,
                                    });
                                }}
                                >
                                ...
                                onClick={() => {
                                    navigate("/admin/view-core/" + row.id, {
                                    state: row,
                                    });
                                }}
                                >
